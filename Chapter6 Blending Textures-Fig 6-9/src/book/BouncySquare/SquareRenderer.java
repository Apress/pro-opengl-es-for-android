...
class SquareRenderer implements GLSurfaceView.Renderer 
{
    ...
    {       
       ...
       //SQUARE 1
		...
		gl.glLoadIdentity();
		gl.glTranslatef( (float)(Math.sin(mTransY)/2.0f),0.0f, -2.9f);	//6
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) 
    {
         ...
         mSquare1.setTexture(gl,mContext,book.BouncySquare.R.drawable.hedly);
         mSquare2.setTexture(gl,mContext,book.BouncySquare.R.drawable.goldengate);
    }
